...
<body>
    ...
    ?>
        ...
        <tr>
            ...
            <td><?= $results[$i][ville]?></td>
            <td><?= $results[$i][departement]?></td>
            <td><?= $results[$i][latitude]?></td>
            <td><?= $results[$i][longitude]?></td>
            <td><?= $results[$i][population]?></td>
            <td><?= $results[$i][densite]?></td>
        ...
        echo '<style>.tableau {border : 3px solid black;}';
